...
pyynto2 = f'https://api.openweathermap.org/data/2.5/weather?lat={vastaus1[0]["lat"]}&lon={vastaus1[0]["lon"]}&appid=26e95cc1408994e6db89afaf8ef94370'
vastaus2 = requests.get(pyynto2).json()


saa = vastaus2['main']['temp'] - 273.15
print(f'{paikkakunta} paikkakunnalla on {saa:.2f} astetta lämmintä')

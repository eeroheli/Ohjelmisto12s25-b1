#1. Toteuta seuraava luokkahierarkia Python-kielellä: Julkaisu voi olla kirja tai lehti.
...
class Kirja(Julkaisu):
    ...
    def tulosta_tiedot(self):
        print(f'{self.nimi} (kirjailia {self.kirjoittaja}, {self.sivumäärä} sivua)')
